...
if(OpenCV_FOUND)
  ...
  if(WIN32)
    if(TARGET opencv_world)
      get_target_property(opencv_world_path opencv_world LOCATION_RELEASE)
      if(EXISTS ${opencv_world_path})
        set(OpenCV_DLL_PATHS ${opencv_world_path})
      endif()
    else()
      foreach(m ${OpenCV_LIBS})
        get_target_property(${m}_dll_path ${m} LOCATION_RELEASE)
        if(EXISTS ${${m}_dll_path})
          list(APPEND OpenCV_DLL_PATHS ${m}_dll_path)
        endif()
      endforeach()
    endif()
